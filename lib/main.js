...
(function() {
  var $, D, SBLVL, SOBA, TEXT, TRM, TYPES, alert, badge, db_route, debug, help, info, new_db, njs_fs, range, rmrf, rpr, urge, warn, whisper, wrap_as_socket_stream,
      ...
      return function(socket) {
        ...
        (wrap_as_socket_stream(socket)).on('dump', {
          ...
          return SBLVL.dump(db, settings, function(error, data) {
            ...
            urge('ready:', 'dump');
            if (data != null) {
              return through.write((JSON.stringify(data)) + '\n');
            } else {
              return through.end();
            }
          });
