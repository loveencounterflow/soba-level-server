...
(function() {
  var $, D, SBLVL, SOBA, TEXT, TRM, TYPES, alert, badge, db_route, debug, help, info, new_db, njs_fs, range, remove_db, rmrf, rpr, urge, warn, whisper, wrap_as_socket_stream,
  ...
  this.dump = function(me, settings, handler) {
    var Z, db, format, input, limit, prefix, soba_server, _ref, _ref1, _ref2;
