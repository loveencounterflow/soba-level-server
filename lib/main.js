...
(function() {
  ...
  this.dump = function(me, socket, type_with_id, settings) {
    var batch_idx, db, input, limit, prefix, query, rsvp, skip_count, soba_server, _ref, _ref1, _ref2, _ref3;
    warn('©iPuul', settings);
    ...
    rsvp = (_ref3 = settings != null ? settings['rsvp'] : void 0) != null ? _ref3 : null;
    ...
    return input.pipe(D2.$skip_first(skip_count)).pipe(D.$take(limit)).pipe($((function(_this) {
        ...
        switch (type) {
          case 'dump':
            if (CND.isa_function(P)) {
              ...
              _this.dump(db, socket, type_with_id, data);
            }
        }
        return next();
      };
